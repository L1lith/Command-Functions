import CommandArgs from './CommandFunction-2'
...
class CommandFunction {
  constructor(input) {
    ...
    this.command = { options, handler, name }
  }
  execute(args) {
    if (!(args instanceof CommandArgs)) throw new Error('Args must be a CommandArgs instance')
